...
\begin{frame}
	...
	\begin{columns}[c]
		...
		\begin{itemize}
			%\setlength\itemsep{1em}
			\item We are not given useful access as individuals to a resource, we are only given useful access as a team
			\item To be able to do anything useful, assume the role of the \teamName team: \newline \texttt{sudo su - \srvAcctName}
		\end{itemize}
